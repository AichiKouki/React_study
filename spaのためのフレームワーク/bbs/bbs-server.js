...
// publicディレクトリ以下は自動的に返す --- (*3) /public/xxxに来たアクセスに対して、/public/xxxのファイルを返すように指定している
app.use('/public', express.static('./public'))
// トップへのアクセスを/publicへ流す.ルートへのアクセスでも、/publicに強制的にリダイレクトするようにもしている
app.get('/', (req, res) => {
