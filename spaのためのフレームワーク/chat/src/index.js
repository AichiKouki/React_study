...
class ChatApp extends React.Component {
  ...
  componentDidMount () {
    // リアルタイムにログを受信するように設定
    socket.on('chat-msg', (obj) => {//メッセージを受信したら、ログの状態を更新
      const logs2 = this.state.logs
      obj.key = 'key_' + (this.state.logs.length + 1) //ここからは、一つ一つのメッセージを判別するために、keyというプロパティを追加する。
      console.log(obj)
